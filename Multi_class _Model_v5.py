# Better model to check new 4 label prediction-----------------
import pandas as pd
import numpy as np
...
print(f"Bearish target (0): {probs[0]:.2f}")
print(f"Small bearish move (1): {probs[1]:.2f}")
print(f"Small bullish move (2): {probs[2]:.2f}")
print(f"Bullish target (3): {probs[3]:.2f}")
...
if pred_class == 0:
    print("Bearish target trade")
elif pred_class == 1:
    print("Small bearish move")
elif pred_class == 2:
    print("Small bullish move")
elif pred_class == 3:
    print("Bullish target trade")
